...
import { calcGroup, calcSessionTotals, money } from '../lib/calc'
    ...
    <div>
      <div className="panel">
        ...
        <div className="field-row">
          <div className="field">
            <label>Court fee per slot</label>
            <input
              type="number"
              step="0.01"
          ...
          <div className="field">
            <label>Shuttle cost per person</label>
            <input
              type="number"
              step="0.01"
              value={session.shuttle_unit_cost}
              onChange={(e) => updateSessionField('shuttle_unit_cost', Number(e.target.value))}
            />
          </div>
          <div className="field">
            <label>Guest fixed rate</label>
            <input
              type="number"
              step="0.01"
