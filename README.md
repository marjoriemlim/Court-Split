...
- **Export as image** renders the ledger as a PNG receipt to send to the group. On phones it opens the native share sheet; elsewhere it downloads. It's drawn on a canvas rather than screenshotting the table, so the Remove buttons and headcount inputs stay out of it.
